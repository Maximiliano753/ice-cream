            ...
            <div class="flex">
                <div class="box">
                    <div class="input-field">
                        ...
                        <input type="text" name="name" required maxlength="50" placeholder="enter yout name" class="input"> 
                    </div>
                    <div class="input-field">
                        <p>your number <span>*</span></p>
                        <input type="number" name="number" required maxlength="10" placeholder="enter yout number" class="input"> 
                    </div>
                    <div class="input-field">
                        <p>your email <span>*</span></p>
                        <input type="email" name="email" required maxlength="50" placeholder="enter yout email" class="input"> 
                    </div>
                    <div class="input-field">
